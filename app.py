...
def main():
    ...
    filtered = filtered_base[["Date","svc","period","hours","score","original_data_idx"]].copy()
    ...
    if apply:
        ...
        for display_idx in range(len(edited_reset)):
            ...
            if score_changed:
                ...
                # Apply score change
                final_score = max(0.0, min(10.0, new_score))
                final_hours = old_hours
